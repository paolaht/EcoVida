                        ...
                        <div class="col-sm-6">
                            <div class="catalogo wow flipInY" data-wow-duration="1000ms" data-wow-delay="300ms">
                                <div class="catalogo-construc-image">
                                    ...
                                    <img width="159" src="/' . $ruta_imgen . '">
                                </div>
                                <div class="info">
                                    <h3><a href="modelo.blade.php?nombre=<?= $model->nombre ?>&descripcion=<?= $model->descripcion ?>&video=<?= $model->video ?>"><?= $model->nombre ?></a></h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                            <div class="alianzas-image">
                                <img class="img-responsive" src="images<?= $alianza->imagen ?>" alt="">
                            </div>
                        </div>
                        @endforeach
